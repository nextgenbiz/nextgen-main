...
function Support() {
  ...
  const businessTypes = [
    ...
    },
    {
      ...
      description:
        "Traditional business structure for two or more persons with shared profits.",
      category: "registration",
    },
    {
      title: "Udyam Registration",
      description:
        "Government registration for MSMEs to access benefits and subsidies.",
      category: "registration",
    },
    {
    ...
    },
    {
      ...
      description:
        "Simplest business structure owned and operated by one individual.",
      category: "registration",
    },
    {
      title: "GST Compliance",
      description:
        "Ensure your business stays compliant with GST regulations and filings.",
      category: "compliance",
    },
    {
      title: "Tax Filing",
      description:
        "Professional tax filing services for businesses of all sizes.",
      category: "compliance",
    },
    {
      title: "Annual Compliance",
      description:
        "Meet all annual compliance requirements for your business entity.",
      category: "compliance",
    },
    {
      title: "Seed Funding",
      description:
        "Assistance in securing seed funding for early-stage startups.",
      category: "funding",
    },
    {
      title: "VC Funding",
      description:
        "Connect with venture capitalists and secure growth funding.",
      category: "funding",
    },
    {
      title: "Business Loans",
      description:
        "Access to business loans from various financial institutions.",
      category: "funding",
    },
    {
      ...
      <section className="w-full bg-gradient-to-b from-[#e8f4ff] to-[#e8f4ff] py-12 md:py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center  mb-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-3 p-2 md:p-3 bg-white rounded-lg shadow-lg border border-gray-200 w-full max-w-4xl mx-auto">
              <button
            ...
            {filteredBusinessTypes.map((business, index) => (
              <div
                ...
                className={`bg-white rounded-lg p-5 md:p-6 shadow-md border border-gray-200 transition-all duration-300 cursor-pointer hover:shadow-lg ${
                  activeCard === index
                    ? "ring-2 ring-[#4a90e2] transform scale-[1.02]"
                    : ""
                }`}
