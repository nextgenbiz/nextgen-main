...
export default function GrowthSection() {
  return (
    <section className="w-full py-8 md:py-12 lg:py-16 px-4 relative bg-white">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center font-semibold text-[#05325f] text-2xl md:text-4xl lg:text-[44.7px] leading-normal mb-8 md:mb-12 lg:mb-16">
        ...
        <div className="relative">
          ...
          <div
            className="absolute inset-0 w-full h-full z-0 opacity-20 hidden lg:block"
            style={{
              backgroundImage:
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
            {steps.map((step, idx) => (
              <div key={idx} className={`flex justify-center lg:${step.justify}`}>
                <div className="flex flex-col items-center lg:items-start max-w-md text-center lg:text-left">
                  <div className="mb-4 lg:mb-6">
                    <Image
                      ...
                      width={101}
                      height={81}
                      className="w-20 h-16 lg:w-[101px] lg:h-[81px]"
                    />
                  </div>
                  <h3 className="font-bold text-[#05325f] text-xl lg:text-[26.8px] leading-normal mb-3 lg:mb-4">
                    {step.title}
                  </h3>
                  <p className="font-normal text-[#46484f] text-base lg:text-[17.9px] leading-normal">
                    {step.description}
                  </p>
                </div>
              </div>
          ...
          <div className="absolute top-1/4 right-1/4 z-5 hidden lg:block">
            <Image
